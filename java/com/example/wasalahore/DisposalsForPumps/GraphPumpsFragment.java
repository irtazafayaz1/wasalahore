 ...
 */
public class GraphPumpsFragment extends Fragment {


    public GraphPumpsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_graph_pumps, container, false);

        BarChart barChart = view.findViewById(R.id.bar_chart_pumps);
