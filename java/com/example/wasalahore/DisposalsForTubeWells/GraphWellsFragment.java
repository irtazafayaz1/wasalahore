...
public class GraphWellsFragment extends Fragment {

    public GraphWellsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_graph_wells, container, false);

        BarChart barChart = view.findViewById(R.id.bar_chart_wells);
